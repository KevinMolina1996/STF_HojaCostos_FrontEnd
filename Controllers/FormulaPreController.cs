...
{
    public class FormulaPreController : Controller
    {
        private FormulaPrecosteoService _services;

        public FormulaPreController()
        {
            _services = new FormulaPrecosteoService();
        }
        ...
        {
            TBL_FORMULA_PRE param = new TBL_FORMULA_PRE();
            try
            {
